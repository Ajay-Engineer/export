        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="text-left">
              <h1 className="text-4xl font-bold text-white mb-2">Decor Items</h1>
              <p className="text-xl text-red-100">Elegant decorative items and home accessories</p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => navigate('/products')} className="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-3 py-2 rounded-md" aria-label="Open menu">
...
export default DecorItemsProducts;