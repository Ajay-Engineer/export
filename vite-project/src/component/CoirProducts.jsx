        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="text-left">
              <h1 className="text-4xl font-bold text-white mb-2">Coir Products</h1>
              <p className="text-xl text-red-100">Explore our range of coir-based products</p>
            </div>
